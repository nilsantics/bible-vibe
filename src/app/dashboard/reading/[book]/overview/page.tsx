    ...
    <div className="flex overflow-hidden" style={{ height: 'calc(100vh - 53px)' }}>
      ...
      {!overview ? (
        ...
        <div className="space-y-6">
          ...
          {/* Summary */}
          {overview?.summary && (
            <p className="text-sm leading-7 text-foreground/75 border-l-2 border-primary/30 pl-4"
              style={{ fontFamily: 'system-ui' }}>
              {overview.summary}
            </p>
          )}
            ...
            {[
              ...
              <Card key={label} className="p-3 border-border">
                <div className="flex items-center gap-1.5 mb-1.5">
                  ...
                  <p className="text-[10px] font-bold text-muted-foreground/60 uppercase tracking-widest" style={{ fontFamily: 'system-ui' }}>
                    {label}
                  </p>
                </div>
                <p className="text-sm leading-snug" style={{ fontFamily: 'system-ui' }}>{value}</p>
              </Card>
            ))}
          </div>
